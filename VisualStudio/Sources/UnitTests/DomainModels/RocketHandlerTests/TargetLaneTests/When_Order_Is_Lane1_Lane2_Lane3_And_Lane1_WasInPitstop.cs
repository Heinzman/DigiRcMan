...
{
    [TestFixture]
    public class When_Order_Is_Lane1_Lane2_Lane3_And_Lane1_WasInPitstop : RocketHandlerTest
    {
        [Test]
        public void Then_TargetLane_Of_Lane1_Should_Be_Null()
        {
            AddMinLapForeachLaneWithPitstopInAndOutForLane1();
        ...
        [Test]
        public void And_NewLap_for_Lane1_Then_TargetLane_Of_Lane1_Should_Be_Lane3()
        {
            AddMinLapForeachLaneWithPitstopInAndOutForLane1();
        ...
        [Test]
        public void And_NewLap_for_Lane1_Then_TargetLane_Of_Lane2_Should_Be_Lane1()
        {
            AddMinLapForeachLaneWithPitstopInAndOutForLane1();
        ...
        [Test]
        public void And_NewLap_for_Lane1_Then_TargetLane_Of_Lane3_Should_Be_Lane2()
        {
            AddMinLapForeachLaneWithPitstopInAndOutForLane1();
        ...
        private void AddMinLapForeachLaneWithPitstopInAndOutForLane1()
        {
            AddMinLapForeachLaneWithPitstopForLane1();
            RaceModel.HandlePitOutFor(LaneId.Lane1);
        }
