...
{
    public class DataGridViewHorizProgressCell : DataGridViewProgressCell
    {
                             ...
                             int progressVal)
        {
            ...
            g.FillRectangle(new SolidBrush(foreColor), cellBounds.X + 2, cellBounds.Y + 2, Convert.ToInt32((percentage * cellBounds.Width - 4)),
                            cellBounds.Height - 4);
            g.DrawString(progressVal.ToString(), cellStyle.Font, new SolidBrush(Color.FromArgb(70, 255, 255, 255)),
                         new Rectangle(cellBounds.X + 1, cellBounds.Y + 1, cellBounds.Width, cellBounds.Height), sFormat);
            g.DrawString(progressVal.ToString(), cellStyle.Font, new SolidBrush(Color.FromArgb(70, 255, 255, 255)),
                         new Rectangle(cellBounds.X - 1, cellBounds.Y + 1, cellBounds.Width, cellBounds.Height), sFormat);
            g.DrawString(progressVal.ToString(), cellStyle.Font, new SolidBrush(Color.FromArgb(70, 255, 255, 255)),
                         new Rectangle(cellBounds.X + 1, cellBounds.Y - 1, cellBounds.Width, cellBounds.Height), sFormat);
