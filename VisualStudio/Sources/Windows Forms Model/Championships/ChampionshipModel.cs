...
namespace Heinzman.DomainModels.Championships
{
    public class ChampionshipModel
    {
        ...
        {
            ChampionshipLane championshipLane = ChampionshipLanes.Find(championshipLane2 => championshipLane2.Driver.Name == driver.Name);
        ...
        private void GetLaneOfChampionshipWithSameDriver(RaceResultLane raceResultLane)
        {
            ...
            {
                if (championshipLane.Driver.Name == raceResultLane.Driver.Name)
